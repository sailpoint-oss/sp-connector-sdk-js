...
describe.skip('class properties and methods', () => {
	it('should add handlers to connector customizer', async () => {
		const customizer = createConnectorCustomizer()
			...
			.beforeStdAccountRead(async (context, input) => {
				return input
			})
			.afterStdAccountRead(async (context, output) => {
				return output
			})
			.beforeStdAccountUpdate(async (context, input) => {
				return input
			})
			.afterStdAccountUpdate(async (context, output) => {
				return output
			})
			.beforeStdAccountDelete(async (context, input) => {
				return input
			})
			.afterStdAccountDelete(async (context, output) => {
				return output
			})
			.beforeStdAccountEnable(async (context, input) => {
				return input
			})
			.afterStdAccountEnable(async (context, output) => {
				return output
			})
			.beforeStdAccountDisable(async (context, input) => {
				return input
			})
			.afterStdAccountDisable(async (context, output) => {
				return output
			})
			.beforeStdAccountUnlock(async (context, input) => {
				return input
			})
			.afterStdAccountUnlock(async (context, output) => {
				return output
			})
			.beforeStdAccountList(async (context, input) => {
				return input
			})
			.afterStdAccountList(async (context, output) => {
				return output
			})
			.beforeStdAuthenticate(async (context, input) => {
				return input
			})
			.afterStdAuthenticate(async (context, output) => {
				return output
			})
			.beforeStdConfigOptions(async (context, input) => {
				return input
			})
			.afterStdConfigOptions(async (context, output) => {
				return output
			})
			.beforeStdApplicationDiscoveryList(async (context, input) => {
				return input
			})
			.afterStdApplicationDiscoveryList(async (context, output) => {
				return output
			})
			.beforeStdEntitlementRead(async (context, input) => {
				return input
			})
			.afterStdEntitlementRead(async (context, output) => {
				return output
			})
			.beforeStdEntitlementList(async (context, input) => {
				return input
			})
			.afterStdEntitlementList(async (context, output) => {
				return output
			})
			.beforeStdChangePassword(async (context, input) => {
				return input
			})
			.afterStdChangePassword(async (context, output) => {
				return output
			})
			.beforeStdSourceDataDiscover(async (context, input) => {
				return input
			})
			.beforeStdSourceDataRead(async (context, input) => {
				return input
			})
			.afterStdSourceDataDiscover(async (context, output) => {
				return output
			})
			.afterStdSourceDataRead(async (context, output) => {
				return output
			})
